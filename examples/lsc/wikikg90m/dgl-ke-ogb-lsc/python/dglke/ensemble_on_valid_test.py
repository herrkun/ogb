...
from dglke.train_pytorch import load_model, test_mp, ensemble_mp, ensemble_test_mp
...
from dglke.models.ensemble_valid_models_test import EnsembleTestModel
...
def main():
    ...
    for i in range(num_proc):
        ...
        proc = mp.Process(target=ensemble_test_mp, args=(
                                                 sys_args,
                                                 valid_sampler,
                                                 i,
                                                 barrier,
